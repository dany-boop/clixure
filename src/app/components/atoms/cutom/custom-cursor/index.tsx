...
const Cursor = () => {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed top-0 left-0 w-4 h-4 rounded-full bg-amber-700 pointer-events-none z-[9999]"
      ...
      <motion.div
        className="fixed top-0 left-0 w-8 h-8 rounded-full bg-amber-700/30 pointer-events-none z-[9998]"
